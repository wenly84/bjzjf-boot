package site.hansi.module.ai.controller.admin.music.vo;
...
public class AiMusicRespVO {
    ...
    @Schema(description = "歌词", example = "夜空中最亮的星能否听清")
    private String lyric;

    @Schema(description = "图片地址", example = "https://www.hansi.site")
    private String imageUrl;

    @Schema(description = "音频地址", example = "https://www.hansi.site")
    private String audioUrl;

    @Schema(description = "视频地址", example = "https://www.hansi.site")

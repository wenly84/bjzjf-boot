...
public class ProjectReactor {
    ...
    private static final String ARTIFACT_ID = "bjzjf";
    private static final String PACKAGE_NAME = "site.hansi";
    private static final String TITLE = "智匠坊科技管理系统";
    ...
    public static void main(String[] args) {
        ...
        String artifactIdNew = "bjzjf";
        String packageNameNew = "site.hansi";
        String titleNew = "智匠坊科技管理系统";
    ...
    private static String getProjectBaseDir() {
        String baseDir = "D:\\workspace\\bjzjf-boot";

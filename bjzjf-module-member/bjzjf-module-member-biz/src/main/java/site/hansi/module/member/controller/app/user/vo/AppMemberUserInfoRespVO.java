package site.hansi.module.member.controller.app.user.vo;
...
public class AppMemberUserInfoRespVO {
    ...
    @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.hansi.site/xxx.png")
    ...
    public static class Level {
        ...
        @Schema(description = "等级图标", example = "https://www.hansi.site/bjzjf.jpg")
        private String icon;

package site.hansi.module.member.convert.user;

import site.hansi.framework.common.pojo.PageResult;
import site.hansi.module.member.api.user.dto.MemberUserRespDTO;
import site.hansi.module.member.controller.admin.user.vo.MemberUserRespVO;
import site.hansi.module.member.controller.admin.user.vo.MemberUserUpdateReqVO;
import site.hansi.module.member.controller.app.user.vo.AppMemberUserInfoRespVO;

...
import site.hansi.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
...
import site.hansi.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, BjzjfRedisAutoConfiguration.class})

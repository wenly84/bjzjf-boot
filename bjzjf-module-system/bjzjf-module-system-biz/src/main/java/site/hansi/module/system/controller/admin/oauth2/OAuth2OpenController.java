...
import site.hansi.framework.common.util.http.HttpUtils;
...
import site.hansi.module.system.convert.oauth2.OAuth2OpenConvert;
...
import site.hansi.module.system.util.oauth2.OAuth2Utils;
...
import static site.hansi.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static site.hansi.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://www.hansi.site"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://www.hansi.site"),

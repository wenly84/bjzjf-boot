package site.hansi.module.system.service.social;
...
import site.hansi.framework.common.util.cache.CacheUtils;
...
import site.hansi.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import site.hansi.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import site.hansi.module.system.dal.dataobject.social.SocialClientDO;
import site.hansi.module.system.dal.mysql.social.SocialClientMapper;
import site.hansi.module.system.dal.redis.RedisKeyConstants;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${bjzjf.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${bjzjf.wxa-subscribe-message.miniprogram-state:formal}")

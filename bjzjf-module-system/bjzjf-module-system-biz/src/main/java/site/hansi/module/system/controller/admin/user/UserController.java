package site.hansi.module.system.controller.admin.user;
...
import site.hansi.module.system.convert.user.UserConvert;
...
public class UserController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("bjzjf").deptId(1L).email("bjzjf@hansi.site").mobile("15601691300")
                        .nickname("智匠坊").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
                UserImportExcelVO.builder().username("test").deptId(2L).email("test@hansi.site").mobile("15601701300")
                        .nickname("测试").status(CommonStatusEnum.DISABLE.getStatus()).sex(SexEnum.FEMALE.getSex()).build()
        );
        // 输出

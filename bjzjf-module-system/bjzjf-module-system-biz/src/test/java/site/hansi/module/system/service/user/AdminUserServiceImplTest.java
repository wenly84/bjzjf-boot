package site.hansi.module.system.service.user;
...
import site.hansi.framework.common.util.collection.ArrayUtils;
...
import site.hansi.module.infra.api.config.ConfigApi;
import site.hansi.module.infra.api.file.FileApi;
import site.hansi.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import site.hansi.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import site.hansi.module.system.controller.admin.user.vo.user.*;
import site.hansi.module.system.dal.dataobject.dept.DeptDO;
import site.hansi.module.system.dal.dataobject.dept.PostDO;
import site.hansi.module.system.dal.dataobject.dept.UserPostDO;
...
import site.hansi.module.system.dal.mysql.dept.UserPostMapper;
import site.hansi.module.system.dal.mysql.user.AdminUserMapper;
import site.hansi.module.system.enums.common.SexEnum;
import site.hansi.module.system.service.dept.DeptService;
...
import site.hansi.module.system.service.tenant.TenantService;
...
import static site.hansi.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("bjzjfyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("bjzjfyuanma");
        ...
        assertEquals("bjzjfyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("bjzjfyuanma"))).thenReturn("java");

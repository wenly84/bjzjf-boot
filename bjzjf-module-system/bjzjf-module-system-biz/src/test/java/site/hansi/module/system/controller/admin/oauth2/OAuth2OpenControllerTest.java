package site.hansi.module.system.controller.admin.oauth2;
...
import site.hansi.framework.common.exception.ErrorCode;
...
import site.hansi.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import site.hansi.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import site.hansi.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import site.hansi.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import site.hansi.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import site.hansi.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import site.hansi.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import site.hansi.module.system.service.oauth2.OAuth2ApproveService;
import site.hansi.module.system.service.oauth2.OAuth2ClientService;
import site.hansi.module.system.service.oauth2.OAuth2GrantService;
import site.hansi.module.system.service.oauth2.OAuth2TokenService;
...
public class OAuth2OpenControllerTest extends BaseMockitoUnitTest {
    ...
    public void testApproveOrDeny_ApproveNo() {
        ...
        String clientId = randomString();
        String scope = "{\"read\": true, \"write\": false}";
        String redirectUri = "https://www.hansi.site";
        String state = "test";
        // mock 方法
        OAuth2ClientDO client = randomPojo(OAuth2ClientDO.class);
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.hansi.site#error=access_denied&error_description=User%20denied%20access&state=test", result.getData());
    }
    ...
    public void testApproveOrDeny_autoApproveWithToken() {
        ...
        assertThat(result.getData(), anyOf( // 29 和 30 都有一定概率，主要是时间计算
                is("https://www.hansi.site#access_token=test_access_token&token_type=bearer&state=test&expires_in=29&scope=read"),
                is("https://www.hansi.site#access_token=test_access_token&token_type=bearer&state=test&expires_in=30&scope=read")
        ));
    }
    ...
    public void testApproveOrDeny_approveWithCode() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.hansi.site?code=test_code&state=test", result.getData());
    }

package site.hansi.module.system.service.tenant;

import site.hansi.framework.common.enums.CommonStatusEnum;
import site.hansi.framework.common.pojo.PageResult;
import site.hansi.framework.tenant.config.TenantProperties;
...
import site.hansi.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import site.hansi.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import site.hansi.module.system.dal.dataobject.permission.MenuDO;
import site.hansi.module.system.dal.dataobject.permission.RoleDO;
import site.hansi.module.system.dal.dataobject.tenant.TenantDO;
import site.hansi.module.system.dal.dataobject.tenant.TenantPackageDO;
import site.hansi.module.system.dal.mysql.tenant.TenantMapper;
import site.hansi.module.system.enums.permission.RoleCodeEnum;
import site.hansi.module.system.enums.permission.RoleTypeEnum;
import site.hansi.module.system.service.permission.MenuService;
import site.hansi.module.system.service.permission.PermissionService;
import site.hansi.module.system.service.permission.RoleService;
import site.hansi.module.system.service.tenant.handler.TenantInfoHandler;
import site.hansi.module.system.service.tenant.handler.TenantMenuHandler;
import site.hansi.module.system.service.user.AdminUserService;
...
import static site.hansi.framework.test.core.util.RandomUtils.*;
import static site.hansi.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
import static site.hansi.module.system.enums.ErrorCodeConstants.*;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            assertEquals("bjzjf", user.getUsername());
            assertEquals("yuanma", user.getPassword());
            assertEquals("智匠坊", user.getNickname());
        ...
        TenantSaveReqVO reqVO = randomPojo(TenantSaveReqVO.class, o -> {
            ...
            o.setWebsite("https://www.hansi.site");
            o.setUsername("bjzjf");
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("智匠坊"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("智匠坊");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
    ...
    public void testGetTenantByWebsite() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setWebsite("https://www.hansi.site"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByWebsite("https://www.hansi.site");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }

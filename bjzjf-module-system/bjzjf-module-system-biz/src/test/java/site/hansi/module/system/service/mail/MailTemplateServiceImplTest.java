package site.hansi.module.system.service.mail;
...
import site.hansi.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import site.hansi.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import site.hansi.module.system.dal.dataobject.mail.MailTemplateDO;
import site.hansi.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static site.hansi.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("智匠坊")));
        // 测试 code 不匹配

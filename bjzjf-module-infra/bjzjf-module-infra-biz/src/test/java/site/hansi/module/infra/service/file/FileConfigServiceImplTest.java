package site.hansi.module.infra.service.file;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import site.hansi.framework.common.pojo.PageResult;
import site.hansi.module.infra.framework.file.core.client.FileClient;
import site.hansi.module.infra.framework.file.core.client.FileClientConfig;
import site.hansi.module.infra.framework.file.core.client.FileClientFactory;
import site.hansi.module.infra.framework.file.core.client.local.LocalFileClient;
import site.hansi.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import site.hansi.module.infra.framework.file.core.enums.FileStorageEnum;
import site.hansi.framework.test.core.ut.BaseDbUnitTest;
import site.hansi.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import site.hansi.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import site.hansi.module.infra.dal.dataobject.file.FileConfigDO;
import site.hansi.module.infra.dal.mysql.file.FileConfigMapper;
import lombok.Data;
...
import static site.hansi.framework.common.util.date.LocalDateTimeUtils.buildTime;
...
import static site.hansi.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static site.hansi.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileConfig_success() {
        // 准备参数
        Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/bjzjf")
                .put("domain", "https://www.hansi.site").build();
        ...
        assertEquals("/bjzjf", ((LocalFileClientConfig) fileConfig.getConfig()).getBasePath());
        assertEquals("https://www.hansi.site", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigDO dbFileConfig = randomPojo(FileConfigDO.class, o -> o.setStorage(FileStorageEnum.LOCAL.getStorage())
                .setConfig(new LocalFileClientConfig().setBasePath("/bjzjf").setDomain("https://www.hansi.site")));
        ...
        FileConfigSaveReqVO reqVO = randomPojo(FileConfigSaveReqVO.class, o -> {
            ...
            Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/bjzjf2")
                    .put("domain", "https://doc.hansi.site").build();
            o.setConfig(config);
        });
        ...
        assertEquals("/bjzjf2", ((LocalFileClientConfig) fileConfig.getConfig()).getBasePath());
        assertEquals("https://doc.hansi.site", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testFileConfig() throws Exception {
        ...
        when(fileClient.upload(any(), any(), any())).thenReturn("https://www.hansi.site");

        // 调用，并断言
        assertEquals("https://www.hansi.site", fileConfigService.testFileConfig(id));
    }

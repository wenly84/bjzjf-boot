package site.hansi.module.infra.service.db;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.ReflectUtil;
import cn.hutool.crypto.symmetric.AES;
import site.hansi.framework.mybatis.core.type.EncryptTypeHandler;
import site.hansi.framework.mybatis.core.util.JdbcUtils;
import site.hansi.framework.test.core.ut.BaseDbUnitTest;
import site.hansi.module.infra.controller.admin.db.vo.DataSourceConfigSaveReqVO;
import site.hansi.module.infra.dal.dataobject.db.DataSourceConfigDO;
import site.hansi.module.infra.dal.mysql.db.DataSourceConfigMapper;
...
import static site.hansi.module.infra.enums.ErrorCodeConstants.DATA_SOURCE_CONFIG_NOT_EXISTS;
...
public class DataSourceConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void setUp() {
        ...
        dataSourceProperty.setUsername("bjzjf");
    ...
    public void testGetDataSourceConfig_master() {
        ...
        assertEquals("bjzjf", dataSourceConfig.getUsername());
    ...
    public void testGetDataSourceConfigList() {
        ...
        assertEquals("bjzjf", dataSourceConfigList.get(0).getUsername());

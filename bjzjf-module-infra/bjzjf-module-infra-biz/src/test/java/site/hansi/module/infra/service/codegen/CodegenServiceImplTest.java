package site.hansi.module.infra.service.codegen;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.map.MapUtil;
import site.hansi.framework.common.pojo.PageResult;
import site.hansi.framework.test.core.ut.BaseDbUnitTest;
import site.hansi.module.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import site.hansi.module.infra.controller.admin.codegen.vo.CodegenUpdateReqVO;
import site.hansi.module.infra.controller.admin.codegen.vo.column.CodegenColumnSaveReqVO;
import site.hansi.module.infra.controller.admin.codegen.vo.table.CodegenTablePageReqVO;
import site.hansi.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import site.hansi.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import site.hansi.module.infra.dal.dataobject.codegen.CodegenTableDO;
import site.hansi.module.infra.dal.mysql.codegen.CodegenColumnMapper;
import site.hansi.module.infra.dal.mysql.codegen.CodegenTableMapper;
import site.hansi.module.infra.enums.codegen.CodegenFrontTypeEnum;
import site.hansi.module.infra.enums.codegen.CodegenSceneEnum;
import site.hansi.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import site.hansi.module.infra.framework.codegen.config.CodegenProperties;
import site.hansi.module.infra.service.codegen.inner.CodegenBuilder;
import site.hansi.module.infra.service.codegen.inner.CodegenEngine;
import site.hansi.module.infra.service.db.DatabaseTableService;
...
public class CodegenServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateCodegenList() {
        ...
        CodegenCreateListReqVO reqVO = randomPojo(CodegenCreateListReqVO.class,
                o -> o.setDataSourceConfigId(1L).setTableNames(Collections.singletonList("t_bjzjf")));
        // mock 方法（TableInfo）
        TableInfo tableInfo = mock(TableInfo.class);
        when(databaseTableService.getTable(eq(1L), eq("t_bjzjf")))
    ...
    public void testSyncCodegenFromDB() {
        ...
        CodegenTableDO table = randomPojo(CodegenTableDO.class, o -> o.setTableName("t_bjzjf")
    ...
    public void testGetCodegenTablePage() {
        ...
        reqVO.setTableName("bjzjf");
        reqVO.setTableComment("芋");
        reqVO.setClassName("bjzjf");

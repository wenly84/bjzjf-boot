package site.hansi.module.infra.framework.file.core.s3;
...
public class S3FileClientTest {
    ...
    public void testMinIO() throws Exception {
        ...
        config.setAccessSecret("12345678");
        config.setBucket("bjzjf-boot");
    ...
    public void testAliyun() throws Exception {
        ...
        config.setBucket("bjzjf-aoteman");
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setBucket("bjzjf-boot");
        config.setDomain("http://test.hansi.site"); // 如果有自定义域名，则可以设置。
        // 默认上海的 endpoint

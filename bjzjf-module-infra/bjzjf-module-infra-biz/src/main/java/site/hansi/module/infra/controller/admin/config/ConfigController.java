package site.hansi.module.infra.controller.admin.config;
...
import site.hansi.module.infra.controller.admin.config.vo.*;
import site.hansi.module.infra.convert.config.ConfigConvert;
import site.hansi.module.infra.dal.dataobject.config.ConfigDO;
import site.hansi.module.infra.enums.ErrorCodeConstants;
...
public class ConfigController {
    ...
    @Parameter(name = "key", description = "参数键", required = true, example = "bjzjf.biz.username")

...
public class CodegenPreviewRespVO {
    ...
    @Schema(description = "文件路径", requiredMode = Schema.RequiredMode.REQUIRED, example = "java/site.hansi/adminserver/modules/system/controller/test/SysTestDemoController.java")

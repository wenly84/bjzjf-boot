package site.hansi.module.infra.controller.admin.codegen;
...
import site.hansi.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import site.hansi.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import site.hansi.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import site.hansi.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import site.hansi.module.infra.convert.codegen.CodegenConvert;
...
import site.hansi.module.infra.service.codegen.CodegenService;
...
import static site.hansi.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "bjzjf"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "智匠坊")
    })

...
import site.hansi.module.infra.enums.codegen.CodegenColumnHtmlTypeEnum;
import site.hansi.module.infra.enums.codegen.CodegenColumnListConditionEnum;
...
public class CodegenBuilder {
    ...
    /**
     * {@link site.hansi.framework.mybatis.core.dataobject.BaseDO} 的字段
     */
    ...
    private void processColumnExample(CodegenColumnDO column) {
        ...
        if (StrUtil.endWithIgnoreCase(column.getColumnName(), "url")) {
            column.setExample("https://www.hansi.site/");
            return;
        }
        // reason

package site.hansi.module.infra.service.codegen.inner;
...
import site.hansi.framework.apilog.core.enums.OperateTypeEnum;
import site.hansi.framework.common.exception.util.ServiceExceptionUtil;
...
import site.hansi.framework.excel.core.annotations.DictFormat;
import site.hansi.framework.excel.core.convert.DictConvert;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "bjzjf-module-${table.moduleName}/" + // 顶级模块
                "bjzjf-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "bjzjf-module-${table.moduleName}/" + // 顶级模块
                "bjzjf-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "bjzjf-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "bjzjf-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }

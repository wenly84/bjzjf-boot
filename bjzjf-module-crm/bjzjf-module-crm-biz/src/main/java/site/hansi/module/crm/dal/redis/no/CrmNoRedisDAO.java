package site.hansi.module.crm.dal.redis.no;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.DateUtil;
import site.hansi.module.crm.dal.redis.RedisKeyConstants;
...
public class CrmNoRedisDAO {
    ...
    /**
     * 合同 {@link site.hansi.module.crm.dal.dataobject.contract.CrmContractDO}
     */
    public static final String CONTRACT_NO_PREFIX = "HT";

    /**
     * 回款 {@link site.hansi.module.crm.dal.dataobject.receivable.CrmReceivablePlanDO}
     */

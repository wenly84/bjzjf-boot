package site.hansi.module.crm.controller.admin.contact.vo;
...
public class CrmContactRespVO {
    ...
    @Schema(description = "联系人姓名", example = "智匠坊")
    ...
    @DictFormat(site.hansi.module.system.enums.DictTypeConstants.USER_SEX)
    private Integer sex;

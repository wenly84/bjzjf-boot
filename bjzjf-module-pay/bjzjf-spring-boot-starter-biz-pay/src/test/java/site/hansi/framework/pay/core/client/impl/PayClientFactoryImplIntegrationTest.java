...
import site.hansi.framework.pay.core.client.impl.alipay.AlipayPayClientConfig;
import site.hansi.framework.pay.core.client.impl.alipay.AlipayQrPayClient;
import site.hansi.framework.pay.core.client.impl.alipay.AlipayWapPayClient;
import site.hansi.framework.pay.core.client.impl.weixin.WxPayClientConfig;
import site.hansi.framework.pay.core.client.impl.weixin.WxPubPayClient;
...
//        System.out.println(result);
    ...
    public void testCreatePayClient_WX_PUB_V3() throws FileNotFoundException {
        ...
        config.setPrivateKeyContent(IoUtil.readUtf8(new FileInputStream("/Users/bjzjf/Downloads/wx_pay/apiclient_key.pem")));
        config.setPrivateCertContent(IoUtil.readUtf8(new FileInputStream("/Users/bjzjf/Downloads/wx_pay/apiclient_cert.pem")));
...
//        System.out.println(result);
    ...
    public void testCreatePayClient_ALIPAY_QR() {
        ...
        // 发起支付
        PayOrderUnifiedReqDTO reqDTO = buildPayOrderUnifiedReqDTO();
        reqDTO.setNotifyUrl("https://www.hansi.site/admin-api/pay/notify/callback/18"); // TODO @tina: 这里改成你的 natapp 回调地址

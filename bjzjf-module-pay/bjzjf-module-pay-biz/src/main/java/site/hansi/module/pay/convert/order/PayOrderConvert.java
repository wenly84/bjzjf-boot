package site.hansi.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, site.hansi.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);

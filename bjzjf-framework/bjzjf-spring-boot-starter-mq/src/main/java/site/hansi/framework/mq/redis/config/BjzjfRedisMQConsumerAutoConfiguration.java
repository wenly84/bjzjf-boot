...
import site.hansi.framework.common.enums.DocumentEnum;
import site.hansi.framework.mq.redis.core.RedisMQTemplate;
import site.hansi.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import site.hansi.framework.mq.redis.core.pubsub.AbstractRedisChannelMessageListener;
import site.hansi.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
...
public class BjzjfRedisMQConsumerAutoConfiguration {

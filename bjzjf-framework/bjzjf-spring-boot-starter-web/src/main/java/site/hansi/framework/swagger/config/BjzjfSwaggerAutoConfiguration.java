package site.hansi.framework.swagger.config;
...
import static site.hansi.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
public class BjzjfSwaggerAutoConfiguration {

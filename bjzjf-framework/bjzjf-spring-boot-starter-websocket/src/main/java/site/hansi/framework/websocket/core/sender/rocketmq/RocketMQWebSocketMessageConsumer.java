package site.hansi.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${bjzjf.websocket.sender-rocketmq.topic}",
        consumerGroup = "${bjzjf.websocket.sender-rocketmq.consumer-group}",

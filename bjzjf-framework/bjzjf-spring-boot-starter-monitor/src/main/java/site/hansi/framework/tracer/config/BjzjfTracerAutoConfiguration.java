...
import site.hansi.framework.tracer.core.aop.BizTraceAspect;
import site.hansi.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "bjzjf.tracer", value = "enable", matchIfMissing = true)
public class BjzjfTracerAutoConfiguration {

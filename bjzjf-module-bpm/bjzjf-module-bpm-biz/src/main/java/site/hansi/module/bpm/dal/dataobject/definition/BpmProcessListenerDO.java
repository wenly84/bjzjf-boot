package site.hansi.module.bpm.dal.dataobject.definition;
...
public class BpmProcessListenerDO extends BaseDO {
     ...
     * 状态
     *
     * 枚举 {@link site.hansi.framework.common.enums.CommonStatusEnum}
     */
    private Integer status;
    /**
     * 监听类型
     *
     * 枚举 {@link site.hansi.module.bpm.enums.definition.BpmProcessListenerType}
     *

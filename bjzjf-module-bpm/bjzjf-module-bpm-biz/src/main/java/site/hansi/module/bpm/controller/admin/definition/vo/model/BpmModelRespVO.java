package site.hansi.module.bpm.controller.admin.definition.vo.model;
...
public class BpmModelRespVO {
    ...
    @Schema(description = "流程标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "process_bjzjf")
    private String key;

    @Schema(description = "流程名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "智匠坊")
    private String name;

    @Schema(description = "流程图标", example = "https://www.hansi.site/bjzjf.jpg")
    private String icon;

package site.hansi.module.product.controller.admin.spu.vo;

import site.hansi.framework.excel.core.annotations.DictFormat;
import site.hansi.framework.excel.core.convert.DictConvert;
import site.hansi.framework.excel.core.convert.MoneyConvert;
import site.hansi.module.product.enums.DictTypeConstants;
...
public class ProductSpuRespVO {
    ...
    @Schema(description = "商品封面图", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.hansi.site/xx.png")
    @ExcelProperty("商品封面图")
    private String picUrl;

    @Schema(description = "商品轮播图", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.hansi.site/xx.png, https://www.hansi.site/xxx.png]")

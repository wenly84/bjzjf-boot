package site.hansi.module.trade.service.brokerage;
...
import site.hansi.module.product.api.sku.ProductSkuApi;
import site.hansi.module.product.api.sku.dto.ProductSkuRespDTO;
import site.hansi.module.product.api.spu.ProductSpuApi;
import site.hansi.module.product.api.spu.dto.ProductSpuRespDTO;
import site.hansi.module.trade.controller.admin.brokerage.vo.record.BrokerageRecordPageReqVO;
import site.hansi.module.trade.controller.app.brokerage.vo.record.AppBrokerageProductPriceRespVO;
import site.hansi.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
import site.hansi.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankPageReqVO;
import site.hansi.module.trade.convert.brokerage.BrokerageRecordConvert;
import site.hansi.module.trade.dal.dataobject.brokerage.BrokerageRecordDO;
import site.hansi.module.trade.dal.dataobject.brokerage.BrokerageUserDO;
import site.hansi.module.trade.dal.dataobject.config.TradeConfigDO;
import site.hansi.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
import site.hansi.module.trade.enums.brokerage.BrokerageRecordBizTypeEnum;
import site.hansi.module.trade.enums.brokerage.BrokerageRecordStatusEnum;
import site.hansi.module.trade.service.brokerage.bo.BrokerageAddReqBO;
import site.hansi.module.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
import site.hansi.module.trade.service.config.TradeConfigService;
...
import static site.hansi.framework.common.util.collection.CollectionUtils.getMaxValue;
import static site.hansi.framework.common.util.collection.CollectionUtils.getMinValue;
import static site.hansi.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static site.hansi.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;

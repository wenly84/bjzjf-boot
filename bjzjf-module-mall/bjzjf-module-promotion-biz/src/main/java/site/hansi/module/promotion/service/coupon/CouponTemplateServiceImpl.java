package site.hansi.module.promotion.service.coupon;

import site.hansi.framework.common.enums.CommonStatusEnum;
import site.hansi.framework.common.pojo.PageResult;
import site.hansi.module.product.api.category.ProductCategoryApi;
import site.hansi.module.product.api.spu.ProductSpuApi;
import site.hansi.module.promotion.controller.admin.coupon.vo.template.CouponTemplateCreateReqVO;
import site.hansi.module.promotion.controller.admin.coupon.vo.template.CouponTemplatePageReqVO;
import site.hansi.module.promotion.controller.admin.coupon.vo.template.CouponTemplateUpdateReqVO;
import site.hansi.module.promotion.convert.coupon.CouponTemplateConvert;
import site.hansi.module.promotion.dal.dataobject.coupon.CouponTemplateDO;
import site.hansi.module.promotion.dal.mysql.coupon.CouponTemplateMapper;
import site.hansi.module.promotion.enums.common.PromotionProductScopeEnum;
import site.hansi.module.promotion.enums.coupon.CouponTakeTypeEnum;
...
import static site.hansi.module.promotion.enums.ErrorCodeConstants.COUPON_TEMPLATE_NOT_EXISTS;
import static site.hansi.module.promotion.enums.ErrorCodeConstants.COUPON_TEMPLATE_TOTAL_COUNT_TOO_SMALL;

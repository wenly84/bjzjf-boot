package site.hansi.module.promotion.controller.admin.combination.vo.recrod;
...
public class CombinationRecordBaseVO {
    ...
    @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.hansi.site/xxx.jpg")
    ...
    @Schema(description = "商品图片", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.hansi.site/1.png")

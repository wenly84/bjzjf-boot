package site.hansi.module.mp.controller.admin.menu.vo;
...
import static site.hansi.module.mp.framework.mp.core.util.MpUtils.*;
...
public class MpMenuBaseVO {
    ...
    @Schema(description = "网页链接", example = "https://www.hansi.site/")

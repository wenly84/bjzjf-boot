package site.hansi.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import site.hansi.framework.common.pojo.PageResult;
import site.hansi.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import site.hansi.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import site.hansi.module.mp.convert.message.MpMessageConvert;
import site.hansi.module.mp.dal.dataobject.account.MpAccountDO;
import site.hansi.module.mp.dal.dataobject.message.MpMessageDO;
import site.hansi.module.mp.dal.dataobject.user.MpUserDO;
import site.hansi.module.mp.dal.mysql.message.MpMessageMapper;
import site.hansi.module.mp.enums.message.MpMessageSendFromEnum;
import site.hansi.module.mp.framework.mp.core.MpServiceFactory;
import site.hansi.module.mp.framework.mp.core.util.MpUtils;
import site.hansi.module.mp.service.account.MpAccountService;
import site.hansi.module.mp.service.material.MpMaterialService;
import site.hansi.module.mp.service.message.bo.MpMessageSendOutReqBO;
import site.hansi.module.mp.service.user.MpUserService;
...
import static site.hansi.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;

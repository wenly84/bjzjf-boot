...
import site.hansi.module.mp.controller.admin.message.vo.autoreply.MpAutoReplyCreateReqVO;
import site.hansi.module.mp.controller.admin.message.vo.autoreply.MpAutoReplyUpdateReqVO;
import site.hansi.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import site.hansi.module.mp.convert.message.MpAutoReplyConvert;
import site.hansi.module.mp.dal.dataobject.account.MpAccountDO;
import site.hansi.module.mp.dal.dataobject.message.MpAutoReplyDO;
import site.hansi.module.mp.dal.mysql.message.MpAutoReplyMapper;
import site.hansi.module.mp.enums.message.MpAutoReplyTypeEnum;
...
import static site.hansi.module.mp.enums.ErrorCodeConstants.*;

package site.hansi.module.mp.service.account;
...
import site.hansi.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import site.hansi.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import site.hansi.module.mp.convert.account.MpAccountConvert;
import site.hansi.module.mp.dal.dataobject.account.MpAccountDO;
import site.hansi.module.mp.dal.mysql.account.MpAccountMapper;
import site.hansi.module.mp.enums.ErrorCodeConstants;
...
import static site.hansi.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 bjzjf-module-mp - 表结构未导入][参考 https://doc.hansi.site/mp/build/ 开启]");
            }
